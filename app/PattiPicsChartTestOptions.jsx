//Patti Pics Chart Test without speech
...
const PattiPicsChartTestOptions = () => {
  // Test state
  ...
  const getOptions = (correctAnswer) => {
    const optionsPool = ['apple', 'house', 'star', 'circle', 'square'];
  ...
  // Trigger saving results when test is complete
  useEffect(() => {
...
export default PattiPicsChartTestOptions;
