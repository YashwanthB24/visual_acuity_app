...
const TumblingEChartTest = () => {
  ...
  const processTranscribedText = (text) => {
    ...
    const numberMappings = {
      'Write': 'right', 'right': 'right', 'eight': 'right', 'ate': 'right', 'eat': 'right',
      'left': 'left',
      'up': 'up', 
      'down': 'down', "don't": 'down',"dont": 'down',"Dont": 'down',
    };
...
export default TumblingEChartTest;