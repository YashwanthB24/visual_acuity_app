  ...
  const saveTestResults = async () => {
    ...
    const processTranscribedText = (text) => {
      ...
      const numberMappings = {
        'horse': 'horse', 'course': 'horse', 'hours':'horse', 'hour':'horse','house':'horse','horses':'horse','ors':'horse',
        'giraffe': 'giraffe','graph': 'giraffe',
        'rabbit': 'rabbit',
        'goat': 'goat','go': 'goat', 'good':'goat',
        'dog': 'dog','doggy': 'dog',
        'cat': 'cat', 'at': 'cat', 'get': 'cat',
        'bird': 'bird','but': 'bird','bud': 'bird',
        'seahorse': 'seahorse','seehorse': 'seahorse',
        'elephant': 'elephant','leafend':'elephant',
      };
  ...
  export default AnimalsChartTest;