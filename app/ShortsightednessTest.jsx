    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            style={styles.selectButton}
            onPress={() => router.push('/TumblingEChartTest')} // Navigate to SnellenDigitChartTest page
          >
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            style={styles.selectButton}
            onPress={() => router.push('/PattiPicsChartTest')} // Navigate to PattiPicsChartTest page
          >
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            style={styles.selectButton}
            onPress={() => router.push('/AnimalsChartTest')} // Navigate to AnimalsChartTest page
          >
